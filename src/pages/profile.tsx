...
export default function Profile() {
    ...
    const [programmingKnowledge, setProgrammingKnowledge] = useState<'beginner' | 'intermediate' | 'advanced'>('beginner');
    const [priorRoboticsExperience, setPriorRoboticsExperience] = useState(false);
    const [learningGoals, setLearningGoals] = useState<string[]>([]);
    const [learningStyle, setLearningStyle] = useState<'hands-on' | 'theory-first' | 'mixed'>('mixed');
                    ...
                    <form onSubmit={handleSubmit} className={styles.form}>
                        ...
                        <div className={styles.formGroup}>
                            ...
                            <select
                                ...
                                onChange={(e) => setProgrammingKnowledge(e.target.value as any)}
                                disabled={loading}
                            >
